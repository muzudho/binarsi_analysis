...
📖 [doコマンドリファレンス](./docs/do_command_reference.md)  
...
👇　ここで路を 3、演算に s1　を指定し `do 3s1` とコマンドを打鍵すると、下図のように変化します  
...
👇　再びノットについて説明します。路を 4、演算に n を指定し `do 4n` とコマンドを打鍵すると、下図のように変化します  
...
👇　路を**石が置いていない** 5、演算に a を指定し `do 5a` とコマンドを打鍵すると、下図のように変化します  
...
👇　路を**石が置いている** 4、演算に a を指定し `do 4a` とコマンドを打鍵すると、下図のように変化します  
